...
| **Work** | What work exists, what is mine, what can I claim, where does it stand? | Queue (all open work / open to claim / mine / resolved), Projects, Tasks, Correspondence | `/work` |
...
| Team (everyone on a team) | Who is on my team, and where does its work stand? Leaders: who carries what? | Workload (totals for all; per person for leaders), Roster with access levels, All teams, Unit dashboard, Invitations, Roles, Units, Access log | `/team` |
| People (team leaders and administrators) | Who can do what, on which team? | Access levels by team, membership, invitations; accounts for organization administrators | `/people` |
