...
export interface RefUpdate { id: string; note: string; url: string }
export interface EvalReference { system?: string; order: string; citation: string; url: string; updates?: RefUpdate[]; authoritative?: string }

export const EVAL_REFERENCES: Record<string, EvalReference> = {
  jepes: {
  ...
  pftcft: {
    order: 'MCO 6100.13A',
    citation: 'MCO 6100.13A w/ CH-5 (28 May 2025)',
  ...
  arq: { order: 'MCO 3574.2M', citation: 'MCO 3574.2M (6 Apr 2022)', url: 'https://www.marines.mil/News/Publications/MCPEL/Electronic-Library-Display/Article/2996982/mco-35742m/' },
  mcmap: { order: 'MCO 1500.59A', citation: 'MCO 1500.59A (23 Sep 2019)', url: 'https://www.marines.mil/News/Publications/MCPEL/Electronic-Library-Display/Article/899428/mco-150059a/' },
};

export const REC_KINDS: Record<string, { label: string; tone: 'neutral' | 'accent' | 'good' }> = {
  data: { label: 'From your log', tone: 'neutral' },
  heuristic: { label: 'Coaching heuristic', tone: 'accent' },
  official: { label: 'Official reference', tone: 'good' },
};
