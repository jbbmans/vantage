  ...
  return (
    <>
      <button
        ...
        className={cn(
          'group flex w-full flex-col items-start gap-1.5 px-4 py-4 text-left transition-colors hover:bg-surface-2',
          tone === 'tracked' && 'border-l-[3px] border-l-line-strong'
        )}
      >
...
export function MetricTotalsGrid({ headline, tracked, prior, params, emptyTitle, emptyDescription, emptyAction }: {
  ...
  return (
    <div className="hairline-grid grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3">
