...
const font = readFileSync('public/fonts/inter-tight-latin.woff2').toString('base64');
const fontFace = `@font-face{font-family:'Inter Tight';src:url(data:font/woff2;base64,${font}) format('woff2');font-weight:300 800}`;
...
// social card
const og = `<div style="width:1200px;height:630px;background:linear-gradient(135deg,#0f172a,#090e1a);display:flex;align-items:center;padding:0 96px;box-sizing:border-box;font-family:'Inter Tight',Inter,system-ui,sans-serif;color:#fff"><div style="display:flex;align-items:center;gap:56px">${mark(220)}<div><div style="font-size:112px;font-weight:700;letter-spacing:0.12em;line-height:1">VANTAGE</div><div style="margin-top:18px;font-size:34px;color:#c9d1e0;letter-spacing:0.02em">Performance, readiness, and career records for Marine Corps teams.</div></div></div></div>`;
